...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 3824.5033112582773 *0.5716228817296797 , (   1912.2516556291387 , 6501.655629139072 ) , 3824.5033112582773 , Units['ft^2']],
        [ 'thrust'                       , 81806.10889774236 *1.017940895005302 , (  24541.83266932271 , 245418.3266932271 ) ,  81806.10889774236 , Units.lbf],
        [ 'cruise_altitude'              , 10670.731707317074 * 0.832337006859191 , ( 6707.317073170732 ,  43000/3.28   ) ,  10670.731707317074  , Units.m],
        [ 'takeoff_weight_guess'         , 232804.23280423277 *0.8017161143763404,  ( 116402.11640211639  ,   465608.46560846554)   ,   232804.23280423277 , Units.kg],
        [ 'wing_sweep'                   , 25 *0.9935178881349538       , (5     ,        45)     ,   25         , Units.deg],
        [ 'wing_toverc'                  , 0.095 *1.5531612343096617       , (.07   ,       .16)     ,     0.095    , Units.less],
        [ 'wing_aspect_ratio'            , 11   *1.194263015846073     , ( 6    ,         14)    ,     11   , Units.less],
       # [ 'bypass_ratio   '              ,   7     , ( 1    ,         17)     ,       7      , Units.less],
      #  [ 'cruise_mach'                  ,   .79       , (.65   ,    .85)     ,      .79        , Units.less],
        [ 'cruise_step'                  ,   2000 / 3.28 *0.9125774795225498, (200  ,     4000)   ,     2000/3.28   , Units.m   ],
        [ 'v2_vs'                        ,   1.2  * 1.0775735986774218     ,  (1.2 ,   1.8)      ,     1.2         , Units.less],
        [ 'fan_pressure_ratio'           ,   1.7   * 1.1096824642351375   ,   (1.05, 3)        ,     1.7         , Units.less]
    ])
    # -------------------------------------------------------------------
    # Objective
    # -------------------------------------------------------------------
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 72.2 , 72.2 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 3063 , 3063 , Units.m],
