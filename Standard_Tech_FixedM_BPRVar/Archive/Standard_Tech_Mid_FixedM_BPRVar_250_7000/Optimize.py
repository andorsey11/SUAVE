...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 2700 , (   2406 , 3000 ) , 2700 , Units['ft^2']],
        ...
        [ 'takeoff_weight_guess'         , 375000/2.204 ,  ( 354000/2.204  ,   450000/2.204)   ,   375000/2.204 , Units.kg],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 72.3 , 72.3 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 2911, 2911 , Units.m],
