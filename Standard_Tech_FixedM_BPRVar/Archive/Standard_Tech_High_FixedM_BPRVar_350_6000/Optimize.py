...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 3000 , (   2200 , 3300 ) , 3000, Units['ft^2']],
        ...
        [ 'takeoff_weight_guess'         , 470000/2.204 ,  ( 420000/2.204  ,   5400000/2.204)   ,   470000/2.204 , Units.kg],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 73.9 , 73.9 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 3290 , 3290 , Units.m],
