...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 3038 , (   1777.7416357113682 , 6044.321561418652 ) , 3555.4832714227364 , Units['ft^2']],
        [ 'thrust'                       , 74264.06374501993  , (  22279.219123505976 , 222792.19123505978 ) ,  74264.06374501993 , Units.lbf],
        [ 'cruise_altitude'              , 10670.731707317074 , ( 6707.317073170732 ,  43000/3.28   ) ,  10670.731707317074  , Units.m],
        [ 'takeoff_weight_guess'         , 211341.0430839002 ,  ( 105670.5215419501  ,   422682.0861678004)   ,   211341.0430839002 , Units.kg],
        [ 'wing_sweep'                   , 31.1        , (5     ,        45)     ,   25         , Units.deg],
        [ 'wing_toverc'                  , 0.128        , (.07   ,       .16)     ,     0.095    , Units.less],
        [ 'wing_aspect_ratio'            , 11.25        , ( 6    ,         14)    ,     11   , Units.less],
      ...
      #  [ 'cruise_mach'                  ,   .79       , (.65   ,    .85)     ,      .79        , Units.less],
        ...
        [ 'fan_pressure_ratio'           ,   1.7       ,   (1.05, 3)        ,     1.7         , Units.less]
    ])
    # -------------------------------------------------------------------
    # Objective
    # -------------------------------------------------------------------
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 73.27179723239999 , 73.27179723239999 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 3208.0021036585367 , 3208.0021036585367 , Units.m],
