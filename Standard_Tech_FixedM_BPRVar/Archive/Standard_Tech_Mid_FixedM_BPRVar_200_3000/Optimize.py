...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 1657.5661384446519 , (   828.7830692223259 , 2817.862435355908 ) , 1657.5661384446519 , Units['ft^2']],
        [ 'thrust'                       , 29697.05179282869  , (  8909.115537848607 , 89091.15537848607 ) ,  29697.05179282869 , Units.lbf],
        [ 'cruise_altitude'              , 10670.731707317074 , ( 6707.317073170732 ,  43000/3.28   ) ,  10670.731707317074  , Units.m],
        [ 'takeoff_weight_guess'         , 84512.01814058957 ,  ( 42256.009070294785  ,   169024.03628117914)   ,   84512.01814058957 , Units.kg],
      ...
      #  [ 'cruise_mach'                  ,   .79       , (.65   ,    .85)     ,      .79        , Units.less],
        ...
        [ 'fan_pressure_ratio'           ,   1.5       ,   (1.05, 1.65)        ,     1.65         , Units.less]
    ])
    # -------------------------------------------------------------------
    # Objective
    # -------------------------------------------------------------------
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 68.9557793868 , 68.9557793868 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 2636.7494817073175 , 2636.7494817073175 , Units.m],
