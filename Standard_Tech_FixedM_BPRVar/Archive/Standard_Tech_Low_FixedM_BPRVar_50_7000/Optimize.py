...
def main():
   ...
   # output = problem.objective()
    ...
    output = pyopt_setup.Pyoptsparse_Solve(problem,solver='ALPSO', sense_step=1.0E-5)
    #print(output)        
...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 917.941585535466 , (  880, 1300 ) , 917.941585535466 , Units['ft^2']],
        ...
        [ 'takeoff_weight_guess'         , 90000/2.204 ,  ( 75000/2.204 ,   105000/2.204)   ,   90000/2.204, Units.kg],
