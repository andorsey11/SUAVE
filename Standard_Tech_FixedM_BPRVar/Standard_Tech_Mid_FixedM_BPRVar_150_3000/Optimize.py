...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 1317.2060829444886 , (   658.6030414722443 , 2239.2503410056306 ) , 1317.2060829444886 , Units['ft^2']],
        [ 'thrust'                       , 23012.111553784864  , (  6903.633466135459 , 69036.33466135459 ) ,  23012.111553784864 , Units.lbf],
        [ 'cruise_altitude'              , 10188.360433604337 , ( 6707.317073170732 ,  43000/3.28   ) ,  10188.360433604337  , Units.m],
        [ 'takeoff_weight_guess'         , 65487.98185941043 ,  ( 32743.990929705215  ,   130975.96371882086)   ,   65487.98185941043 , Units.kg],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 68.3083875132 , 68.3083875132 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 2551.063018292683 , 2551.063018292683 , Units.m],
