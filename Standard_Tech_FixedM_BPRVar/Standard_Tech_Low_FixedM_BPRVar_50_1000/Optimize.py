...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 387.3236006413991 , (   193.66180032069954 , 658.4501210903784 ) , 387.3236006413991 , Units['ft^2']],
        [ 'thrust'                       , 6336.095617529882  , (  1900.8286852589645 , 19008.286852589645 ) ,  6336.095617529882 , Units.lbf],
        [ 'cruise_altitude'              , 8770.447154471545 , ( 6707.317073170732 ,  43000/3.28   ) ,  8770.447154471545  , Units.m],
        [ 'takeoff_weight_guess'         , 18031.2925170068 ,  ( 9015.6462585034  ,   36062.5850340136)   ,   18031.2925170068 , Units.kg],
      ...
      #  [ 'cruise_mach'                  ,   .79       , (.65   ,    .85)     ,      .79        , Units.less],
        ...
        [ 'fan_pressure_ratio'           ,   1.7       ,   (1.05, 2.11)        ,     1.7         , Units.less]
    ])
    # -------------------------------------------------------------------
    # Objective
    # -------------------------------------------------------------------
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 66.69342659879999 , 66.69342659879999 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 1660.3396341463415 , 1660.3396341463415 , Units.m],
