...
def base_setup():
    ...
    vehicle.tag = 'StandardTechLow_50_8000'

    vehicle.mass_properties.max_takeoff = 110000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 110000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 43999.99999999999 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 54999.99999999999 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 1024.8447204968945  * Units['feet**2']
    vehicle.passengers             = 50
    vehicle.systems.control        = "fully powered" 
    vehicle.systems.accessories    = "long range" 
    vehicle.cruise_altitude    = 31888.88888888889 
    vehicle.cruise_step        = 2000 / 3.28 * Units.m 
    vehicle.cruise_mach        =0.85 
    ...
    landing_gear.main_tire_diameter = 39.46060990412425 * Units.inches
    landing_gear.nose_tire_diameter = 30.565133726716898 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 1024.8447204968945 * Units['feet**2']
    ...
    wing.areas.reference         = 256.21118012422363 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    wing.areas.reference         = 204.96894409937892 * Units['feet**2']
    wing.aspect_ratio            = 2
    ...
    thrust.total_design             = 35059.760956175305 * Units.lbf
