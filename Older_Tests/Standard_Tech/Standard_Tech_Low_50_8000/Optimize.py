...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 1024.8447204968945 , (   512.4223602484473 , 1742.2360248447205 ) , 1024.8447204968945 , Units['ft^2']],
        [ 'thrust'                       , 17529.880478087653  , (  5258.964143426296 , 52589.64143426296 ) ,  17529.880478087653 , Units.lbf],
        [ 'cruise_altitude'              , 9722.222222222223 , ( 9722.222222222223 ,  43000/3.28   ) ,  9722.222222222223  , Units.m],
        [ 'takeoff_weight_guess'         , 49886.621315192744 ,  ( 24943.310657596372  ,   99773.24263038549)   ,   49886.621315192744 , Units.kg],
      ...
      #  [ 'fan_pressure_ratio'              ,   1.65     , ( 1.05    ,         1.7)     ,       1.65      , Units.less],
        [ 'cruise_mach'                  , 0.85, (.50   ,    .88)     , 0.85   , Units.less],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 67.77747000000001 , 67.77747000000001 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 2480.7926829268295 , 2480.7926829268295 , Units.m],
