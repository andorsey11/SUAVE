...
def setup():
    ...
    problem.inputs = np.array([
        ...
        [ 'thrust'                       , 40068.298235628914  , (  12020.489470688673 , 80136.59647125783 ) ,  40068.298235628914 , Units.lbf],
      ...
      #  [ 'fan_pressure_ratio'              ,   1.65     , ( 1.05    ,         1.7)     ,       1.65      , Units.less],
        [ 'cruise_mach'                  , 0.7675, (.50   ,    .88)     , 0.7675   , Units.less],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 69.96016542857143 , 69.96016542857143 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 2769.6864111498257 , 2769.6864111498257 , Units.m],
