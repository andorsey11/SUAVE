...
def base_setup():
    ...
    vehicle.tag = 'StandardTechLow_100_8000'

    vehicle.mass_properties.max_takeoff = 220000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 220000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 87999.99999999999 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 109999.99999999999 * Units.lbs 
