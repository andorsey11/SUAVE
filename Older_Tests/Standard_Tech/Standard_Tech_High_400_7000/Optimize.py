...
def setup():
    ...
    problem.inputs = np.array([
        ...
        [ 'cruise_altitude'              , 10670.731707317074 , ( 3048.7804878048782 ,  43000/3.28   ) ,  10670.731707317074  , Units.m],
        [ 'takeoff_weight_guess'         , 354749.3071302595 ,  ( 177374.65356512976  ,   709498.614260519)   ,   354749.3071302595 , Units.kg],
        [ 'wing_sweep'                   , 25        , (0     ,        45)     ,   25         , Units.deg],
      ...
      #  [ 'fan_pressure_ratio'              ,   1.65     , ( 1.05    ,         1.7)     ,       1.65      , Units.less],
        [ 'cruise_mach'                  , 0.8362499999999999, (.50   ,    .88)     , 0.8362499999999999   , Units.less],
        [ 'cruise_step'                  ,   2000 / 3.28, (200  ,     4000)   ,     2000/3.28   , Units.m   ],
        [ 'v2_vs'                        ,   1.2        ,  (1.2 ,   1.5)      ,     1.2         , Units.less]
    ])
    # -------------------------------------------------------------------
    # Objective
    # -------------------------------------------------------------------
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 78.15200999999999 , 78.15200999999999 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 3853.9295392953936 , 3853.9295392953936 , Units.m],
