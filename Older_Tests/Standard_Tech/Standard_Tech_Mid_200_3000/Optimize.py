...
def setup():
    ...
    problem.inputs = np.array([
        ...
        [ 'thrust'                       , 43150.47502298499  , (  12945.142506895496 , 86300.95004596998 ) ,  43150.47502298499 , Units.lbf],
      ...
      #  [ 'fan_pressure_ratio'              ,   1.65     , ( 1.05    ,         1.7)     ,       1.65      , Units.less],
        [ 'cruise_mach'                  , 0.78125, (.50   ,    .88)     , 0.78125   , Units.less],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 70.25865369230769 , 70.25865369230769 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 2809.1932457786115 , 2809.1932457786115 , Units.m],
