...
def base_setup():
    ...
    vehicle.tag = 'StandardTechHigh_300_8000'

    vehicle.mass_properties.max_takeoff = 660000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 660000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 264000.0 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 330000.0 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 4583.333333333333  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 55.777235916735876 * Units.inches
    landing_gear.nose_tire_diameter = 53.74572728287033 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 4583.333333333333 * Units['feet**2']
    ...
    wing.areas.reference         = 1145.8333333333333 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    wing.areas.reference         = 916.6666666666666 * Units['feet**2']
    wing.aspect_ratio            = 2
    ...
    thrust.total_design             = 210358.5657370518 * Units.lbf
