...
def header_vehicle_write(vehicle_file,payload,design_range):
             ...
             vehicle_file.write("    vehicle.tag = 'StandardTechHigh_" + str(payload) + "_" + str(design_range)+"'\n\n")    
             return vehicle_file
