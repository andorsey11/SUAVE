...
def base_setup():
    ...
    vehicle.tag = 'StandardTechMid_250_8000'

    vehicle.mass_properties.max_takeoff = 550000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 550000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 219999.99999999997 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 275000.0 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 4024.390243902439  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 52.6641278216056 * Units.inches
    landing_gear.nose_tire_diameter = 50.746004260870144 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 4024.390243902439 * Units['feet**2']
    ...
    wing.areas.reference         = 1006.0975609756098 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    wing.areas.reference         = 804.8780487804879 * Units['feet**2']
    wing.aspect_ratio            = 2
    ...
    thrust.total_design             = 175298.8047808765 * Units.lbf
