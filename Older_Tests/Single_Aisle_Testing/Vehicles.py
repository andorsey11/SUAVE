...
def base_setup():
    ...
    vehicle.cruise_altitude    = 33000 * Units.ft
    ...
    wing.q_cl_vertical           = 1.1 * 40 #Constant variable of maximum tail Cl at engine failure speed to size tail according to thrust      
    # add to vehicle
    vehicle.append_component(wing)
