...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 1000 , (   965 , 1586.7322027277758 ) , 1000 , Units['ft^2']],
        [ 'thrust'                       , 10640.796812749006  , (  9120 , 25000 ) ,  10640.796812749006 , Units.lbf],
       # [ 'cruise_altitude'              , 35000/3.28 , ( 32000/3.28 ,  43000/3.28   ) ,  35000/3.28 , Units.m],
        [ 'takeoff_weight_guess'         , 90000/2.204 ,  ( 85000/2.204  ,   105000/2.204)   ,   90000/2.204 , Units.kg],
        [ 'wing_sweep'                   , 34.5        , (25     ,        45)     ,   34.5         , Units.deg],
    #    [ 'wing_toverc'                  , 0.101       , (.07   ,       .16)     ,     0.101    , Units.less],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 67.1103081972 , 67.1103081972 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 2039.1664634146343 , 2039.1664634146343 , Units.m],
