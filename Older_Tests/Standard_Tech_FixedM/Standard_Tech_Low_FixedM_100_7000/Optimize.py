...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 1285.6892081174092 , (   642.8446040587046 , 2185.6716537995953 ) , 1285.6892081174092 , Units['ft^2']],
        [ 'thrust'                       , 22409.880478087653  , (  6722.964143426296 , 67229.64143426296 ) ,  22409.880478087653 , Units.lbf],
        [ 'cruise_altitude'              , 10137.154471544716 , ( 6707.317073170732 ,  43000/3.28   ) ,  10137.154471544716  , Units.m],
        [ 'takeoff_weight_guess'         , 63774.14965986394 ,  ( 31887.07482993197  ,   127548.29931972788)   ,   63774.14965986394 , Units.kg],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 68.2500654504 , 68.2500654504 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 2543.3437195121955 , 2543.3437195121955 , Units.m],
