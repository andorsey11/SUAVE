...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 1442.22217401679 , (   721.111087008395 , 2451.777695828543 ) , 1442.22217401679 , Units['ft^2']],
        [ 'thrust'                       , 25428.525896414347  , (  7628.557768924304 , 76285.57768924304 ) ,  25428.525896414347 , Units.lbf],
        [ 'cruise_altitude'              , 10393.821138211382 , ( 6707.317073170732 ,  43000/3.28   ) ,  10393.821138211382  , Units.m],
        [ 'takeoff_weight_guess'         , 72364.62585034013 ,  ( 36182.31292517007  ,   144729.25170068027)   ,   72364.62585034013 , Units.kg],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 68.5424011248 , 68.5424011248 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 2582.036219512195 , 2582.036219512195 , Units.m],
