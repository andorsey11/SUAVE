...
def main():
   ...
   # output = problem.objective()
    ...
    output = pyopt_setup.Pyoptsparse_Solve(problem,solver='SNOPT', sense_step=1.0E-3)
    #print(output)        
...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 4315.929853618742 , (   2157.964926809371 , 7337.080751151861 ) , 4315.929853618742 , Units['ft^2']],
        [ 'thrust'                       , 96563.98406374503  , (  28969.195219123507 , 289691.9521912351 ) ,  96563.98406374503 , Units.lbf],
        [ 'cruise_altitude'              , 10670.731707317074 , ( 6707.317073170732 ,  43000/3.28   ) ,  10670.731707317074  , Units.m],
        [ 'takeoff_weight_guess'         , 274802.26757369615 ,  ( 137401.13378684808  ,   549604.5351473923)   ,   274802.26757369615 , Units.kg],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 75.4313957748 , 75.4313957748 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 3493.83881097561 , 3493.83881097561 , Units.m],
