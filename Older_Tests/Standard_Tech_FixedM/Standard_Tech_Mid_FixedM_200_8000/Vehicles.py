...
def base_setup():
    ...
    vehicle.tag = 'StandardTechMid_200_8000'

    vehicle.mass_properties.max_takeoff = 440000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 440000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 175999.99999999997 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 219999.99999999997 * Units.lbs 
