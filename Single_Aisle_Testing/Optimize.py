...
def setup():
    ...
    problem.inputs = np.array([
        ...
        [ 'thrust'                       ,  2*31000/1.255   , (   2*25000/1.255   ,     2*43000/1.255   ) ,   2*29000/1.255 , Units.lbf],
        ...
        [ 'wing_aspect_ratio'            ,   10.4     , ( 9    ,         13)     ,       10.4      , Units.less],
        [ 'fan_pressure_ratio'              ,   1.7     , ( 1.05    ,         1.8)     ,       1.7      , Units.less],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 150*.51444, 150*.51444, Units['m/sec']],
        ...
        #[ 'landing_diff'   , '>',  0 , 1, Units.less],
        #[ 'mzfw_diff'      , '>',  0,  1, Units.less]
        #[ 'wing_span'      , '<',   118/3.28, 118/3.28, Units.m]
      

       # [ 'takeoff_diff_lower', '>', 0, 1, Units.kg],
       # [ 'design_range_fuel_margin' , '>', 0.0, 1, Units.less], 
       # [ 'approach_speed_diff', '<', .1*.51444, .1*.5144, Units['m/sec']], #Get approach speed to within .1 knots
       # [ 'max_throttle_diff',  '<',  .001, .001, Units.less],
       # [ 'tofl_diff',  '>', 2, 2, Units.m],
       # [ 'second_seg_diff', '<', .0001, .0001, Units.less],
       # [ 'fuel_margin_diff', '>', .001, .001, Units.less],
         #[ 'fuel_margin_no_reserve',   '>',  0, 1, Units.less]
