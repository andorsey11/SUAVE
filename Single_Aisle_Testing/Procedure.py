...
def post_process(nexus):
  ...
  #  print(vehicle.mass_properties.breakdown.propulsion)
    ...
    print('lpc work done ' + str(vehicle.propulsors['turbofan'].low_pressure_compressor.outputs.work_done[0][0]))
    print('hpc work done ' + str(vehicle.propulsors['turbofan'].high_pressure_compressor.outputs.work_done[0][0]))
    print('fan work done ' + str(vehicle.propulsors['turbofan'].fan.outputs.work_done[0][0])) 
    #print('fan work done ' + str(vehicle.propulsors['turbofan'].low_pressure_turbine.inputs.work[0][0])) 
    #print('fan work done ' + str(vehicle.propulsors['turbofan'].high_pressure_turbine.inputs.work[0][0]))   
    print('core exit velocity ' + str(vehicle.propulsors['turbofan'].core_nozzle.outputs.mach_number[0][0]))
    print('core exit stag temp ' + str(vehicle.propulsors['turbofan'].core_nozzle.outputs.stagnation_temperature[0][0]))    
    import pdb; pdb.set_trace()
