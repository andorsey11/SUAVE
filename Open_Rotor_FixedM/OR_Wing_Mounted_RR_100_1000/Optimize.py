...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 1285.0182801218407 , (   642.5091400609203 , 2184.531076207129 ) , 1285.0182801218407 , Units['ft^2']],
        [ 'thrust'                       , 18450.080731642603  , (  5535.0242194927805 , 55350.24219492781 ) ,  18450.080731642603 , Units.lbf],
        [ 'cruise_altitude'              , 10090.677453257029 , ( 6707.317073170732 ,  43000/3.28   ) ,  10090.677453257029  , Units.m],
        [ 'takeoff_weight_guess'         , 62218.59231309239 ,  ( 31109.296156546196  ,   124437.18462618478)   ,   62218.59231309239 , Units.kg],
        [ 'wing_sweep'                   , 18.491243755437363        , (5     ,        45)     ,   18.491243755437363         , Units.deg],
        [ 'wing_toverc'                  , 0.10364375155056847        , (.07   ,       .16)     ,     0.10364375155056847    , Units.less],
        [ 'wing_aspect_ratio'            , 8.293496270769115        , ( 6    ,         14)    ,     8.293496270769115   , Units.less],
        [ 'econ_takeoff_weight_guess'    , 49774.873850473916 ,  ( 18665.577693927717  ,   93327.8884696386)   ,   49774.873850473916 , Units.kg],
        [ 'cruise_step'                  ,   2000 / 3.28, (200  ,     4000)   ,     2000/3.28   , Units.m   ],
        [ 'v2_vs'                        ,   1.2        ,  (1.2 ,   1.8)      ,     1.2         , Units.less],
        [ 'fan_pressure_ratio'           , 1.0793445990778923  ,   (1.05, 1.4)        ,     1.2         , Units.less],
    ...
    problem.aliases = [
        ...
        [ 'thrust'                           ,     ['vehicle_configurations.*.propulsors.openrotor.thrust.total_design',
                                                    'vehicle_configurations.*.propulsors.openrotor.thrust.design_thrust'  ]],
