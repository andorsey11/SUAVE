...
def simple_sizing(nexus):
    ...
    # Calibrate Clmaxs to Vos https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.831.7369&rep=rep1&type=pdf
    ...
    takeoff.maximum_lift_coefficient = max_CL_takeoff * 1.4/2.2
    #Base config CL_max
    ...
    #Compute available cabin area, given 8.25 ft as a required t to be considered cabin
