...
def main():
   ...
   # output = problem.objective()
    ...
    output = pyopt_setup.Pyoptsparse_Solve(problem,solver='SLSQP', sense_step=5.0E-4)
    #print(output)        
...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 3389.2181763951257 , (   1694.6090881975629 , 5761.670899871714 ) , 3389.2181763951257 , Units['ft^2']],
        [ 'thrust'                       , 69777.52988047809  , (  20933.258964143428 , 209332.58964143426 ) ,  69777.52988047809 , Units.lbf],
        [ 'cruise_altitude'              , 10670.731707317074 , ( 6707.317073170732 ,  43000/3.28   ) ,  10670.731707317074  , Units.m],
        [ 'takeoff_weight_guess'         , 198573.24263038547 ,  ( 99286.62131519274  ,   397146.48526077095)   ,   198573.24263038547 , Units.kg],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 72.83730635279998 , 72.83730635279998 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 3150.4944512195125 , 3150.4944512195125 , Units.m],
