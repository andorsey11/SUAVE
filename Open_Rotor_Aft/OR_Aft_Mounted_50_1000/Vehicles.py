...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted50_1000'

    vehicle.mass_properties.max_takeoff = 58666.666666666664 * Units.lbs 
    vehicle.mass_properties.takeoff  = 58666.666666666664 * Units.lbs 
    vehicle.mass_properties.operating_empty = 33733.33333333333 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 44733.33333333333 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 46933.333333333336 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 564.5851154833191  * Units['feet**2']
    vehicle.passengers             = 50
    vehicle.systems.control        = "fully powered" 
    vehicle.systems.accessories    = "short range" 
    vehicle.cruise_altitude    = 29607.40740740741 
    vehicle.cruise_step        = 2000 / 3.28 * Units.m 
    vehicle.cruise_mach        =0.74625 
    ...
    landing_gear.main_tire_diameter = 32.37191510085646 * Units.inches
    landing_gear.nose_tire_diameter = 25.07442019907023 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 564.5851154833191 * Units['feet**2']
    ...
    wing.areas.reference         = 112.91702309666383 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 141.14627887082978 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 18698.53917662683 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 46933.333333333336* Units.lbs
