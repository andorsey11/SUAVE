...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted400_7000'

    vehicle.mass_properties.max_takeoff = 782222.2222222222 * Units.lbs 
    vehicle.mass_properties.takeoff  = 782222.2222222222 * Units.lbs 
    vehicle.mass_properties.operating_empty = 332444.4444444444 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 420444.4444444444 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 625777.7777777779 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 5141.187925998052  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 58.843655755999215 * Units.inches
    landing_gear.nose_tire_diameter = 56.70046252041158 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 5141.187925998052 * Units['feet**2']
    ...
    wing.areas.reference         = 1028.2375851996105 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 1285.296981499513 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 249313.85568835773 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 625777.7777777779* Units.lbs
