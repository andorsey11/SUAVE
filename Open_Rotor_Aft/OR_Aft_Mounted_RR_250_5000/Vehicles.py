...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted250_5000'

    vehicle.mass_properties.max_takeoff = 399999.99999999994 * Units.lbs 
    vehicle.mass_properties.takeoff  = 399999.99999999994 * Units.lbs 
    vehicle.mass_properties.operating_empty = 189999.99999999997 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 244999.99999999997 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 320000.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3157.894736842105  * Units['feet**2']
    vehicle.passengers             = 250
    vehicle.systems.control        = "fully powered" 
    vehicle.systems.accessories    = "long range" 
    vehicle.cruise_altitude    = 35000 
    vehicle.cruise_step        = 2000 / 3.28 * Units.m 
    vehicle.cruise_mach        =0.81125 
    ...
    landing_gear.main_tire_diameter = 47.63756410943382 * Units.inches
    landing_gear.nose_tire_diameter = 45.9025171643126 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 3157.894736842105 * Units['feet**2']
    ...
    wing.areas.reference         = 631.578947368421 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 789.4736842105262 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 127490.03984063746 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 320000.0* Units.lbs
