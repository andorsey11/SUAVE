...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted300_2000'

    vehicle.mass_properties.max_takeoff = 377142.8571428571 * Units.lbs 
    vehicle.mass_properties.takeoff  = 377142.8571428571 * Units.lbs 
    vehicle.mass_properties.operating_empty = 207428.5714285714 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 273428.57142857136 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 301714.2857142857 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3013.698630136986  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 46.76274572795969 * Units.inches
    landing_gear.nose_tire_diameter = 45.05956126339742 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 3013.698630136986 * Units['feet**2']
    ...
    wing.areas.reference         = 602.7397260273973 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 753.4246575342465 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 120204.89470688674 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 301714.2857142857* Units.lbs
