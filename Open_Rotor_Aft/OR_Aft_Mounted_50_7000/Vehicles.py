...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted50_7000'

    vehicle.mass_properties.max_takeoff = 97777.77777777778 * Units.lbs 
    vehicle.mass_properties.takeoff  = 97777.77777777778 * Units.lbs 
    vehicle.mass_properties.operating_empty = 41555.55555555555 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 52555.55555555555 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 78222.22222222223 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 917.941585535466  * Units['feet**2']
    vehicle.passengers             = 50
    vehicle.systems.control        = "fully powered" 
    vehicle.systems.accessories    = "long range" 
    vehicle.cruise_altitude    = 31345.679012345678 
    vehicle.cruise_step        = 2000 / 3.28 * Units.m 
    vehicle.cruise_mach        =0.84375 
    ...
    landing_gear.main_tire_diameter = 38.02338254066188 * Units.inches
    landing_gear.nose_tire_diameter = 29.451895825258795 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 917.941585535466 * Units['feet**2']
    ...
    wing.areas.reference         = 183.5883171070932 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 229.4853963838665 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    fan.polytropic_efficiency = 0.751
    ...
    thrust.total_design             = 31164.231961044716 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 78222.22222222223* Units.lbs
