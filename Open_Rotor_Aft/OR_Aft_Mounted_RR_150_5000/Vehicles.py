...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted150_5000'

    vehicle.mass_properties.max_takeoff = 239999.99999999997 * Units.lbs 
    vehicle.mass_properties.takeoff  = 239999.99999999997 * Units.lbs 
    vehicle.mass_properties.operating_empty = 113999.99999999999 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 147000.0 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 192000.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 2068.965517241379  * Units['feet**2']
    ...
    landing_gear.nose_tire_diameter = 39.07996315082355 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 2068.965517241379 * Units['feet**2']
    ...
    wing.areas.reference         = 413.7931034482758 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 517.2413793103448 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 76494.02390438247 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 192000.0* Units.lbs
