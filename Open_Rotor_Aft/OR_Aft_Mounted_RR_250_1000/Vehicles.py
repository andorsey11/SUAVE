...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted250_1000'

    vehicle.mass_properties.max_takeoff = 293333.3333333333 * Units.lbs 
    vehicle.mass_properties.takeoff  = 293333.3333333333 * Units.lbs 
    vehicle.mass_properties.operating_empty = 168666.66666666666 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 223666.66666666666 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 234666.66666666666 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 2453.531598513011  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 53.74572728287033 * Units.inches
    landing_gear.nose_tire_diameter = 41.630003835011586 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 2453.531598513011 * Units['feet**2']
    ...
    wing.areas.reference         = 490.70631970260223 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 613.3828996282527 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 93492.69588313413 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 234666.66666666666* Units.lbs
