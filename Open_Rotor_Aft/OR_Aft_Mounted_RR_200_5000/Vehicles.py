...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted200_5000'

    vehicle.mass_properties.max_takeoff = 320000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 320000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 152000.0 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 196000.0 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 256000.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 2637.362637362637  * Units['feet**2']
    ...
    landing_gear.nose_tire_diameter = 42.78680399096803 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 2637.362637362637 * Units['feet**2']
    ...
    wing.areas.reference         = 527.4725274725274 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 659.3406593406593 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 101992.03187250996 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 256000.0* Units.lbs
