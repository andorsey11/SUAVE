...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted350_6000'

    vehicle.mass_properties.max_takeoff = 616000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 616000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 277200.0 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 354200.0 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 492800.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 4366.729678638942  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 54.57812018089254 * Units.inches
    landing_gear.nose_tire_diameter = 52.59028552854171 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 4366.729678638942 * Units['feet**2']
    ...
    wing.areas.reference         = 873.3459357277884 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 1091.6824196597354 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 196334.66135458168 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 492800.0* Units.lbs
