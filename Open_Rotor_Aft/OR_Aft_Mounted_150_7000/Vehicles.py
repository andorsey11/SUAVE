...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted150_7000'
    ...
    vehicle.mass_properties.operating_empty = 124666.66666666664 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 157666.66666666663 * Units.lbs 
