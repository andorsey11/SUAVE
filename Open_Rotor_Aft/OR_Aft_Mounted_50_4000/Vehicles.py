...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted50_4000'

    vehicle.mass_properties.max_takeoff = 73333.33333333333 * Units.lbs 
    vehicle.mass_properties.takeoff  = 73333.33333333333 * Units.lbs 
    vehicle.mass_properties.operating_empty = 36666.666666666664 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 47666.666666666664 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 58666.666666666664 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 699.1525423728814  * Units['feet**2']
    vehicle.passengers             = 50
    vehicle.systems.control        = "fully powered" 
    vehicle.systems.accessories    = "medium range" 
    vehicle.cruise_altitude    = 30259.25925925926 
    vehicle.cruise_step        = 2000 / 3.28 * Units.m 
    vehicle.cruise_mach        =0.7949999999999999 
    ...
    landing_gear.main_tire_diameter = 34.72922139434408 * Units.inches
    landing_gear.nose_tire_diameter = 26.90032664781344 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 699.1525423728814 * Units['feet**2']
    ...
    wing.areas.reference         = 139.83050847457628 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 174.78813559322035 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 23373.173970783533 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 58666.666666666664* Units.lbs
