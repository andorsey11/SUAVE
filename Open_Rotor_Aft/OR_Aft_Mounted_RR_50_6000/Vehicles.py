...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted50_6000'

    vehicle.mass_properties.max_takeoff = 88000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 88000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 39599.99999999999 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 50599.99999999999 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 70400.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 831.2342569269522  * Units['feet**2']
    vehicle.passengers             = 50
    vehicle.systems.control        = "fully powered" 
    vehicle.systems.accessories    = "long range" 
    vehicle.cruise_altitude    = 30911.11111111111 
    ...
    landing_gear.main_tire_diameter = 36.78215238802798 * Units.inches
    landing_gear.nose_tire_diameter = 28.490472124685855 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 831.2342569269522 * Units['feet**2']
    ...
    wing.areas.reference         = 166.24685138539044 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 207.80856423173805 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    fan.polytropic_efficiency = 0.761
    ...
    thrust.total_design             = 28047.80876494024 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 70400.0* Units.lbs
