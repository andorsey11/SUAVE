...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted100_4000'

    vehicle.mass_properties.max_takeoff = 146666.66666666666 * Units.lbs 
    vehicle.mass_properties.takeoff  = 146666.66666666666 * Units.lbs 
    vehicle.mass_properties.operating_empty = 73333.33333333333 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 95333.33333333333 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 117333.33333333333 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 1336.0323886639676  * Units['feet**2']
    vehicle.passengers             = 100
    vehicle.systems.control        = "fully powered" 
    vehicle.systems.accessories    = "medium range" 
    vehicle.cruise_altitude    = 33518.51851851852 
    ...
    landing_gear.main_tire_diameter = 43.20355612454654 * Units.inches
    landing_gear.nose_tire_diameter = 33.46431982741525 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 1336.0323886639676 * Units['feet**2']
    ...
    wing.areas.reference         = 267.20647773279353 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 334.0080971659919 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 46746.347941567066 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 117333.33333333333* Units.lbs
