...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted400_6000'

    vehicle.mass_properties.max_takeoff = 704000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 704000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 316799.99999999994 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 404799.99999999994 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 563200.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 4791.2885662431945  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 56.92277142285372 * Units.inches
    landing_gear.nose_tire_diameter = 54.84954029713591 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 4791.2885662431945 * Units['feet**2']
    ...
    wing.areas.reference         = 958.257713248639 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 1197.8221415607986 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 224382.47011952192 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 563200.0* Units.lbs
