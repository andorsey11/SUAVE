...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted350_4000'

    vehicle.mass_properties.max_takeoff = 513333.33333333326 * Units.lbs 
    vehicle.mass_properties.takeoff  = 513333.33333333326 * Units.lbs 
    vehicle.mass_properties.operating_empty = 256666.66666666663 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 333666.6666666666 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 410666.6666666666 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3824.5033112582773  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 51.531938616682936 * Units.inches
    landing_gear.nose_tire_diameter = 49.65505145117516 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 3824.5033112582773 * Units['feet**2']
    ...
    wing.areas.reference         = 764.9006622516555 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 956.1258278145693 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 163612.21779548473 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 410666.6666666666* Units.lbs
