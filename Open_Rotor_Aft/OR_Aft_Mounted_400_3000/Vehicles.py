...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted400_3000'

    vehicle.mass_properties.max_takeoff = 541538.4615384615 * Units.lbs 
    vehicle.mass_properties.takeoff  = 541538.4615384615 * Units.lbs 
    vehicle.mass_properties.operating_empty = 284307.69230769225 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 372307.69230769225 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 433230.76923076925 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3978.8997739261495  * Units['feet**2']
    vehicle.passengers             = 400
    ...
    landing_gear.main_strut_length  = 139.30083284789876 * Units.inches
    landing_gear.nose_strut_length  = 139.30083284789876 * Units.inches
    landing_gear.main_tire_diameter = 52.407552809141194 * Units.inches
    landing_gear.nose_tire_diameter = 50.49877417818738 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 3978.8997739261495 * Units['feet**2']
    ...
    wing.origin                  = [32.67455999999999,0,-1.6764]# meters
    wing.vertical                = False
    wing.symmetric               = True
    wing.high_lift               = True
    ...
    wing.areas.reference         = 795.77995478523 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.twists.tip              = 0.0 * Units.degrees
    wing.origin                  = [57.8612,0,5.6997599999999995]
    wing.vertical                = True
    ...
    wing.areas.reference         = 994.7249434815374 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    wing.chords.tip              = wing.chords.root * wing.taper
    wing.chords.mean_aerodynamic = wing.chords.root - (2*(wing.chords.root-wing.chords.tip)*(.5*wing.chords.root+wing.chords.tip)/(3*(wing.chords.root+wing.chords.tip)))
    wing.origin                  = [61.2648,0,5.0291999999999994]
    wing.vertical                = False
    wing.symmetric               = True
    ...
    fuselage.lengths.nose            = 13.4112 * Units.meter 
    fuselage.lengths.tail            = 20.116799999999998 * Units.meter 
    fuselage.lengths.cabin           = 34.544 * Units.meter 
    fuselage.lengths.total           = 68.072 * Units.meter 
    fuselage.lengths.fore_space      = 10.72896 * Units.meter 
    fuselage.lengths.aft_space       = 16.09344 * Units.meter 
    fuselage.width                   = 6.7056 * Units.meter
    fuselage.heights.maximum         = 6.7056 * Units.meter
    fuselage.effective_diameter      = 6.7056 * Units.meter 
    ...
    fuselage.heights.at_quarter_length = 6.7056 * Units.meter
    fuselage.heights.at_three_quarters_length = 6.7056 * Units.meter
    fuselage.heights.at_wing_root_quarter_chord = 6.7056* Units.meter
    ...
    thrust.total_design             = 172601.90009193996 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 433230.76923076925* Units.lbs
