...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted200_7000'

    vehicle.mass_properties.max_takeoff = 391111.1111111111 * Units.lbs 
    vehicle.mass_properties.takeoff  = 391111.1111111111 * Units.lbs 
    vehicle.mass_properties.operating_empty = 166222.2222222222 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 210222.2222222222 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 312888.88888888893 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3102.2326674500587  * Units['feet**2']
    ...
    landing_gear.nose_tire_diameter = 45.578722972627766 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 3102.2326674500587 * Units['feet**2']
    ...
    wing.areas.reference         = 620.4465334900118 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 775.5581668625147 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 124656.92784417886 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 312888.88888888893* Units.lbs
