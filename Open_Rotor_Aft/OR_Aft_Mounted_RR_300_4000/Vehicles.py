...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted300_4000'
    ...
    vehicle.mass_properties.operating_empty = 219999.99999999997 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 286000.0 * Units.lbs 
