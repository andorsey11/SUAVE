...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted150_4000'

    vehicle.mass_properties.max_takeoff = 219999.99999999997 * Units.lbs 
    vehicle.mass_properties.takeoff  = 219999.99999999997 * Units.lbs 
    vehicle.mass_properties.operating_empty = 109999.99999999999 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 143000.0 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 176000.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 1918.6046511627906  * Units['feet**2']
    ...
    landing_gear.nose_tire_diameter = 38.02338254066188 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 1918.6046511627906 * Units['feet**2']
    ...
    wing.areas.reference         = 383.72093023255815 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 479.65116279069764 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 70119.52191235061 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 176000.0* Units.lbs
