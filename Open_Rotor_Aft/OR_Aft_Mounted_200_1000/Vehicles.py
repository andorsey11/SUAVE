...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted200_1000'

    vehicle.mass_properties.max_takeoff = 234666.66666666666 * Units.lbs 
    vehicle.mass_properties.takeoff  = 234666.66666666666 * Units.lbs 
    vehicle.mass_properties.operating_empty = 134933.3333333333 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 178933.3333333333 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 187733.33333333334 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 2029.208301306687  * Units['feet**2']
    ...
    landing_gear.nose_tire_diameter = 38.80429493345329 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 2029.208301306687 * Units['feet**2']
    ...
    wing.areas.reference         = 405.84166026133744 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 507.30207532667174 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 74794.15670650732 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 187733.33333333334* Units.lbs
