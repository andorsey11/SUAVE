...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 1453.7327237701154 , (   726.8663618850577 , 2471.345630409196 ) , 1453.7327237701154 , Units['ft^2']],
        [ 'thrust'                       , 24781.14102784957  , (  7434.342308354871 , 74343.42308354871 ) ,  24781.14102784957 , Units.lbf],
        [ 'cruise_altitude'              , 10429.907768696898 , ( 6707.317073170732 ,  43000/3.28   ) ,  10429.907768696898  , Units.m],
        [ 'takeoff_weight_guess'         , 73572.42327883486 ,  ( 36786.21163941743  ,   147144.84655766972)   ,   73572.42327883486 , Units.kg],
        [ 'wing_sweep'                   , 30.194802022304245        , (5     ,        45)     ,   30.194802022304245         , Units.deg],
        [ 'wing_toverc'                  , 0.08917659179194182        , (.07   ,       .16)     ,     0.08917659179194182    , Units.less],
        [ 'wing_aspect_ratio'            , 9.649960591015995        , ( 6    ,         14)    ,     9.649960591015995   , Units.less],
        [ 'econ_takeoff_weight_guess'    , 58857.938623067894 ,  ( 22071.726983650457  ,   110358.6349182523)   ,   58857.938623067894 , Units.kg],
        [ 'cruise_step'                  ,   2000 / 3.28, (200  ,     4000)   ,     2000/3.28   , Units.m   ],
        [ 'v2_vs'                        ,   1.2        ,  (1.2 ,   1.8)      ,     1.2         , Units.less],
        [ 'fan_pressure_ratio'           , 1.0502180908503858  ,   (1.05, 1.4)        ,     1.2         , Units.less],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 68.59028520000001 , 68.59028520000001 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 2588.1097560975613 , 2588.1097560975613 , Units.m],
    ...
    problem.aliases = [
        ...
        [ 'thrust'                           ,     ['vehicle_configurations.*.propulsors.openrotoraft.thrust.total_design',
                                                    'vehicle_configurations.*.propulsors.openrotoraft.thrust.design_thrust'  ]],
        ...
        [ 'fan_pressure_ratio'               ,      'vehicle_configurations.*.propulsors.openrotoraft.fan.pressure_ratio' ],
        ...
        [ 'bypass_ratio'                     ,      'vehicle_configurations.*.propulsors.openrotoraft.bypass_ratio'       ],                                                                                                                                                                  
        [ 'bypass_factor'                    ,      'vehicle_configurations.*.propulsors.openrotoraft.bypass_factor'      ],                                                                                                                                                                  
