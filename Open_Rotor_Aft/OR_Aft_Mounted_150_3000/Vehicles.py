...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted150_3000'

    vehicle.mass_properties.max_takeoff = 203076.92307692306 * Units.lbs 
    vehicle.mass_properties.takeoff  = 203076.92307692306 * Units.lbs 
    vehicle.mass_properties.operating_empty = 106615.3846153846 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 139615.3846153846 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 162461.53846153847 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 1788.6178861788617  * Units['feet**2']
    vehicle.passengers             = 150
    ...
    landing_gear.main_strut_length  = 84.10027893578365 * Units.inches
    landing_gear.nose_strut_length  = 84.10027893578365 * Units.inches
    landing_gear.main_tire_diameter = 47.86721702883936 * Units.inches
    landing_gear.nose_tire_diameter = 37.07666691333482 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 1788.6178861788617 * Units['feet**2']
    ...
    wing.origin                  = [19.726656,0,-0.9753599999999999]# meters
    wing.vertical                = False
    wing.symmetric               = True
    wing.high_lift               = True
    ...
    wing.areas.reference         = 357.7235772357724 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.twists.tip              = 0.0 * Units.degrees
    wing.origin                  = [34.93262,0,3.316224]
    wing.vertical                = True
    ...
    wing.areas.reference         = 447.1544715447154 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    wing.chords.tip              = wing.chords.root * wing.taper
    wing.chords.mean_aerodynamic = wing.chords.root - (2*(wing.chords.root-wing.chords.tip)*(.5*wing.chords.root+wing.chords.tip)/(3*(wing.chords.root+wing.chords.tip)))
    wing.origin                  = [36.98748,0,2.92608]
    wing.vertical                = False
    wing.symmetric               = True
    ...
    fuselage.lengths.total           = 41.0972 * Units.meter 
    ...
    thrust.total_design             = 64725.71253447748 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 162461.53846153847* Units.lbs
