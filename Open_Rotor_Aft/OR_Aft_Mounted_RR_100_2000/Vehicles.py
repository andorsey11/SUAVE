...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted100_2000'

    vehicle.mass_properties.max_takeoff = 125714.2857142857 * Units.lbs 
    vehicle.mass_properties.takeoff  = 125714.2857142857 * Units.lbs 
    vehicle.mass_properties.operating_empty = 69142.85714285713 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 91142.85714285713 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 100571.42857142857 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 1159.9297012302284  * Units['feet**2']
    vehicle.passengers             = 100
    vehicle.systems.control        = "fully powered" 
    vehicle.systems.accessories    = "short range" 
    vehicle.cruise_altitude    = 32587.301587301587 
    ...
    landing_gear.main_tire_diameter = 41.15581977418938 * Units.inches
    landing_gear.nose_tire_diameter = 31.878197982421064 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 1159.9297012302284 * Units['feet**2']
    ...
    wing.areas.reference         = 231.9859402460457 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 289.9824253075571 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 40068.298235628914 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 100571.42857142857* Units.lbs
