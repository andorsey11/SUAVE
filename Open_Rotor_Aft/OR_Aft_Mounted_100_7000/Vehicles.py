...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted100_7000'

    vehicle.mass_properties.max_takeoff = 195555.55555555556 * Units.lbs 
    vehicle.mass_properties.takeoff  = 195555.55555555556 * Units.lbs 
    vehicle.mass_properties.operating_empty = 83111.1111111111 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 105111.1111111111 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 156444.44444444447 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 1730.0131061598952  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 47.30153097840892 * Units.inches
    landing_gear.nose_tire_diameter = 36.63850161835447 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 1730.0131061598952 * Units['feet**2']
    ...
    wing.areas.reference         = 346.00262123197905 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 432.5032765399738 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 62328.46392208943 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 156444.44444444447* Units.lbs
