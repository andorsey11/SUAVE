...
def main():
   ...
   # output = problem.objective()
    ...
    output = pyopt_setup.Pyoptsparse_Solve(problem,solver='SLSQP', sense_step=1.0E-1)
    #print(output)        
...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 1730.0131061598952 , (   865.0065530799476 , 2941.022280471822 ) , 1730.0131061598952 , Units['ft^2']],
        [ 'thrust'                       , 31164.231961044716  , (  9349.269588313415 , 93492.69588313415 ) ,  31164.231961044716 , Units.lbf],
        [ 'cruise_altitude'              , 10670.731707317074 , ( 6707.317073170732 ,  43000/3.28   ) ,  10670.731707317074  , Units.m],
        [ 'takeoff_weight_guess'         , 88687.32678256488 ,  ( 44343.66339128244  ,   177374.65356512976)   ,   88687.32678256488 , Units.kg],
        [ 'wing_sweep'                   , 25        , (5     ,        45)     ,   25         , Units.deg],
        [ 'wing_toverc'                  , 0.095        , (.07   ,       .16)     ,     0.095    , Units.less],
        [ 'wing_aspect_ratio'            , 11        , ( 6    ,         14)    ,     11   , Units.less],
        [ 'econ_takeoff_weight_guess'    , 70949.86142605191 ,  ( 26606.198034769463  ,   133030.99017384733)   ,   70949.86142605191 , Units.kg],
