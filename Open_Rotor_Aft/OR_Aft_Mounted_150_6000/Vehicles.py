...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted150_6000'

    vehicle.mass_properties.max_takeoff = 264000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 264000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 118799.99999999999 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 151800.0 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 211200.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 2244.8979591836737  * Units['feet**2']
    ...
    landing_gear.nose_tire_diameter = 40.271039625054115 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 2244.8979591836737 * Units['feet**2']
    ...
    wing.areas.reference         = 448.97959183673476 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 561.2244897959184 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 84143.42629482072 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 211200.0* Units.lbs
