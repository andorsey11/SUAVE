...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted200_4000'
    ...
    vehicle.mass_properties.operating_empty = 146666.66666666666 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 190666.66666666666 * Units.lbs 
