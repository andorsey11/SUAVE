...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted350_1000'

    vehicle.mass_properties.max_takeoff = 410666.6666666667 * Units.lbs 
    vehicle.mass_properties.takeoff  = 410666.6666666667 * Units.lbs 
    vehicle.mass_properties.operating_empty = 236133.3333333333 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 313133.3333333333 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 328533.3333333334 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3224.0055826936496  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 48.03411867314375 * Units.inches
    landing_gear.nose_tire_diameter = 46.28462848775193 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 3224.0055826936496 * Units['feet**2']
    ...
    wing.areas.reference         = 644.80111653873 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 806.0013956734124 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 130889.7742363878 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 328533.3333333334* Units.lbs
