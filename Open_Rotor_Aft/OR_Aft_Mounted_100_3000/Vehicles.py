...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted100_3000'

    vehicle.mass_properties.max_takeoff = 135384.61538461538 * Units.lbs 
    vehicle.mass_properties.takeoff  = 135384.61538461538 * Units.lbs 
    vehicle.mass_properties.operating_empty = 71076.92307692306 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 93076.92307692306 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 108307.69230769231 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 1241.7685794920037  * Units['feet**2']
    vehicle.passengers             = 100
    vehicle.systems.control        = "fully powered" 
    vehicle.systems.accessories    = "medium range" 
    vehicle.cruise_altitude    = 33017.094017094016 
    ...
    landing_gear.main_strut_length  = 72.87304763162464 * Units.inches
    landing_gear.nose_strut_length  = 72.87304763162464 * Units.inches
    landing_gear.main_tire_diameter = 42.12786324805218 * Units.inches
    landing_gear.nose_tire_diameter = 32.63111687645198 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 1241.7685794920037 * Units['feet**2']
    ...
    wing.origin                  = [17.093183999999997,0,-0.7010399999999999]# meters
    wing.vertical                = False
    wing.symmetric               = True
    wing.high_lift               = True
    ...
    wing.areas.reference         = 248.35371589840076 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.twists.tip              = 0.0 * Units.degrees
    wing.origin                  = [30.26918,0,2.3835359999999994]
    wing.vertical                = True
    ...
    wing.areas.reference         = 310.4421448730009 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    wing.chords.tip              = wing.chords.root * wing.taper
    wing.chords.mean_aerodynamic = wing.chords.root - (2*(wing.chords.root-wing.chords.tip)*(.5*wing.chords.root+wing.chords.tip)/(3*(wing.chords.root+wing.chords.tip)))
    wing.origin                  = [32.04972,0,2.1031199999999997]
    wing.vertical                = False
    wing.symmetric               = True
    ...
    fuselage.lengths.nose            = 5.608319999999999 * Units.meter 
    fuselage.lengths.tail            = 8.412479999999999 * Units.meter 
    fuselage.lengths.cabin           = 21.59 * Units.meter 
    fuselage.lengths.total           = 35.6108 * Units.meter 
    fuselage.lengths.fore_space      = 4.486655999999999 * Units.meter 
    fuselage.lengths.aft_space       = 6.729983999999999 * Units.meter 
    fuselage.width                   = 2.8041599999999995 * Units.meter
    fuselage.heights.maximum         = 2.8041599999999995 * Units.meter
    fuselage.effective_diameter      = 2.8041599999999995 * Units.meter 
    ...
    fuselage.heights.at_quarter_length = 2.8041599999999995 * Units.meter
    fuselage.heights.at_three_quarters_length = 2.8041599999999995 * Units.meter
    fuselage.heights.at_wing_root_quarter_chord = 2.8041599999999995* Units.meter
    ...
    thrust.total_design             = 43150.47502298499 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 108307.69230769231* Units.lbs
