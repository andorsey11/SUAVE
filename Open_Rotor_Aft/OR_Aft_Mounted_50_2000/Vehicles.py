...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted50_2000'

    vehicle.mass_properties.max_takeoff = 62857.14285714285 * Units.lbs 
    vehicle.mass_properties.takeoff  = 62857.14285714285 * Units.lbs 
    vehicle.mass_properties.operating_empty = 34571.428571428565 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 45571.428571428565 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 50285.71428571428 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 603.2906764168189  * Units['feet**2']
    vehicle.passengers             = 50
    vehicle.systems.control        = "fully powered" 
    vehicle.systems.accessories    = "short range" 
    vehicle.cruise_altitude    = 29793.65079365079 
    vehicle.cruise_step        = 2000 / 3.28 * Units.m 
    vehicle.cruise_mach        =0.7625 
    ...
    landing_gear.main_tire_diameter = 33.08314650032872 * Units.inches
    landing_gear.nose_tire_diameter = 25.625321031275504 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 603.2906764168189 * Units['feet**2']
    ...
    wing.areas.reference         = 120.65813528336378 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 150.82266910420472 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    fan.polytropic_efficiency = 0.796
    ...
    thrust.total_design             = 20034.149117814457 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 50285.71428571428* Units.lbs
