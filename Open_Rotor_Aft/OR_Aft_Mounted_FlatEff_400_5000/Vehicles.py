...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted400_5000'

    vehicle.mass_properties.max_takeoff = 640000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 640000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 304000.0 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 392000.0 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 512000.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 4485.981308411215  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 55.23919497384682 * Units.inches
    landing_gear.nose_tire_diameter = 53.22728277216167 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 4485.981308411215 * Units['feet**2']
    ...
    wing.areas.reference         = 897.196261682243 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 1121.4953271028037 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 203984.06374501993 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 512000.0* Units.lbs
