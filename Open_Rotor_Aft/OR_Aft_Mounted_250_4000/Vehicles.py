...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted250_4000'

    vehicle.mass_properties.max_takeoff = 366666.6666666666 * Units.lbs 
    vehicle.mass_properties.takeoff  = 366666.6666666666 * Units.lbs 
    vehicle.mass_properties.operating_empty = 183333.3333333333 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 238333.3333333333 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 293333.3333333333 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 2946.428571428571  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 46.34961697501333 * Units.inches
    landing_gear.nose_tire_diameter = 44.661479412914304 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 2946.428571428571 * Units['feet**2']
    ...
    wing.areas.reference         = 589.2857142857142 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 736.6071428571428 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 116865.86985391767 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 293333.3333333333* Units.lbs
