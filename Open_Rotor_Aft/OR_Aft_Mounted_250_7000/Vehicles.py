...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted250_7000'

    vehicle.mass_properties.max_takeoff = 488888.8888888889 * Units.lbs 
    vehicle.mass_properties.takeoff  = 488888.8888888889 * Units.lbs 
    vehicle.mass_properties.operating_empty = 207777.77777777775 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 262777.77777777775 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 391111.1111111111 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3687.150837988827  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 50.746004260870144 * Units.inches
    landing_gear.nose_tire_diameter = 48.89774225763948 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 3687.150837988827 * Units['feet**2']
    ...
    wing.areas.reference         = 737.4301675977654 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 921.7877094972067 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 155821.15980522358 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 391111.1111111111* Units.lbs
