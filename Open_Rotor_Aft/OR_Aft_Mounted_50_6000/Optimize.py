...
def main():
   ...
   # output = problem.objective()
    ...
    output = pyopt_setup.Pyoptsparse_Solve(problem,solver='SNOPT', sense_step=1.0E-2)
    #print(output)        
...
def setup():
    ...
    problem.inputs = np.array([
        [ 'wing_area'                    , 831.2342569269522 , (   415.6171284634761 , 1413.0982367758186 ) , 831.2342569269522 , Units['ft^2']],
        [ 'thrust'                       , 14023.90438247012  , (  4207.1713147410355 , 42071.71314741036 ) ,  14023.90438247012 , Units.lbf],
        [ 'cruise_altitude'              , 9424.119241192411 , ( 6707.317073170732 ,  43000/3.28   ) ,  9424.119241192411  , Units.m],
        [ 'takeoff_weight_guess'         , 39909.297052154194 ,  ( 19954.648526077097  ,   79818.59410430839)   ,   39909.297052154194 , Units.kg],
        [ 'wing_sweep'                   , 25        , (5     ,        45)     ,   25         , Units.deg],
        [ 'wing_toverc'                  , 0.095        , (.07   ,       .16)     ,     0.095    , Units.less],
        [ 'wing_aspect_ratio'            , 11        , ( 6    ,         14)    ,     11   , Units.less],
        [ 'econ_takeoff_weight_guess'    , 31927.437641723358 ,  ( 11972.789115646257  ,   59863.94557823129)   ,   31927.437641723358 , Units.kg],
