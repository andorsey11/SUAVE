...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted50_5000'

    vehicle.mass_properties.max_takeoff = 80000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 80000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 38000.0 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 49000.0 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 64000.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 759.493670886076  * Units['feet**2']
    vehicle.passengers             = 50
    vehicle.systems.control        = "fully powered" 
    vehicle.systems.accessories    = "long range" 
    vehicle.cruise_altitude    = 30555.555555555555 
    ...
    landing_gear.main_tire_diameter = 35.694264993293636 * Units.inches
    landing_gear.nose_tire_diameter = 27.647823625829542 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 759.493670886076 * Units['feet**2']
    ...
    wing.areas.reference         = 151.8987341772152 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 189.873417721519 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 25498.00796812749 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 64000.0* Units.lbs
