...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted250_6000'

    vehicle.mass_properties.max_takeoff = 440000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 440000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 197999.99999999997 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 252999.99999999997 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 352000.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3402.061855670103  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 49.08945856699554 * Units.inches
    landing_gear.nose_tire_diameter = 47.30153097840892 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 3402.061855670103 * Units['feet**2']
    ...
    wing.areas.reference         = 680.4123711340206 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 850.5154639175257 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 140239.04382470122 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 352000.0* Units.lbs
