...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted250_3000'

    vehicle.mass_properties.max_takeoff = 338461.53846153844 * Units.lbs 
    vehicle.mass_properties.takeoff  = 338461.53846153844 * Units.lbs 
    vehicle.mass_properties.operating_empty = 177692.30769230766 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 232692.30769230766 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 270769.23076923075 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 2761.5062761506274  * Units['feet**2']
    vehicle.passengers             = 250
    ...
    landing_gear.main_strut_length  = 112.61016953916891 * Units.inches
    landing_gear.nose_strut_length  = 112.61016953916891 * Units.inches
    landing_gear.main_tire_diameter = 45.19559269366635 * Units.inches
    landing_gear.nose_tire_diameter = 43.54948680009149 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 2761.5062761506274 * Units['feet**2']
    ...
    wing.origin                  = [26.413968,0,-1.4020799999999998]# meters
    wing.vertical                = False
    wing.symmetric               = True
    wing.high_lift               = True
    ...
    wing.areas.reference         = 552.3012552301255 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.twists.tip              = 0.0 * Units.degrees
    wing.origin                  = [46.77473499999999,0,4.767071999999999]
    wing.vertical                = True
    ...
    wing.areas.reference         = 690.3765690376569 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    wing.chords.tip              = wing.chords.root * wing.taper
    wing.chords.mean_aerodynamic = wing.chords.root - (2*(wing.chords.root-wing.chords.tip)*(.5*wing.chords.root+wing.chords.tip)/(3*(wing.chords.root+wing.chords.tip)))
    wing.origin                  = [49.52619,0,4.206239999999999]
    wing.vertical                = False
    wing.symmetric               = True
    ...
    fuselage.seats_abreast           = 8
    fuselage.seat_pitch              = 0.8635999999999999 * Units.meter
    fuselage.fineness.nose           = 2
    fuselage.fineness.tail           = 3
    fuselage.lengths.nose            = 11.216639999999998 * Units.meter 
    fuselage.lengths.tail            = 16.824959999999997 * Units.meter 
    fuselage.lengths.cabin           = 26.987499999999997 * Units.meter 
    fuselage.lengths.total           = 55.0291 * Units.meter 
    fuselage.lengths.fore_space      = 8.973311999999998 * Units.meter 
    fuselage.lengths.aft_space       = 13.459967999999998 * Units.meter 
    fuselage.width                   = 5.608319999999999 * Units.meter
    fuselage.heights.maximum         = 5.608319999999999 * Units.meter
    fuselage.effective_diameter      = 5.608319999999999 * Units.meter 
    ...
    fuselage.heights.at_quarter_length = 5.608319999999999 * Units.meter
    fuselage.heights.at_three_quarters_length = 5.608319999999999 * Units.meter
    fuselage.heights.at_wing_root_quarter_chord = 5.608319999999999* Units.meter
    ...
    thrust.total_design             = 107876.18755746246 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 270769.23076923075* Units.lbs
