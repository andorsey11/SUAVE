...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted350_7000'

    vehicle.mass_properties.max_takeoff = 684444.4444444444 * Units.lbs 
    vehicle.mass_properties.takeoff  = 684444.4444444444 * Units.lbs 
    vehicle.mass_properties.operating_empty = 290888.8888888888 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 367888.8888888888 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 547555.5555555555 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 4699.898270600203  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 56.419883211178124 * Units.inches
    landing_gear.nose_tire_diameter = 54.36496819107395 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 4699.898270600203 * Units['feet**2']
    ...
    wing.areas.reference         = 939.9796541200408 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 1174.9745676500509 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 218149.62372731298 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 547555.5555555555* Units.lbs
