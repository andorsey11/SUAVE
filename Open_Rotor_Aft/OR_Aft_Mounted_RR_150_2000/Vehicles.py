...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted150_2000'

    vehicle.mass_properties.max_takeoff = 188571.42857142855 * Units.lbs 
    vehicle.mass_properties.takeoff  = 188571.42857142855 * Units.lbs 
    vehicle.mass_properties.operating_empty = 103714.2857142857 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 136714.28571428568 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 150857.14285714284 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 1675.1269035532994  * Units['feet**2']
    ...
    landing_gear.nose_tire_diameter = 36.22117296403375 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 1675.1269035532994 * Units['feet**2']
    ...
    wing.areas.reference         = 335.0253807106599 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 418.78172588832484 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 60102.44735344337 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 150857.14285714284* Units.lbs
