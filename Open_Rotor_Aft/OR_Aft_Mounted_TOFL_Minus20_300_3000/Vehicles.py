...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted300_3000'

    vehicle.mass_properties.max_takeoff = 406153.8461538461 * Units.lbs 
    vehicle.mass_properties.takeoff  = 406153.8461538461 * Units.lbs 
    vehicle.mass_properties.operating_empty = 213230.7692307692 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 279230.7692307692 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 324923.07692307694 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3196.1259079903143  * Units['feet**2']
    vehicle.passengers             = 300
    ...
    landing_gear.main_strut_length  = 121.90555471614621 * Units.inches
    landing_gear.nose_strut_length  = 121.90555471614621 * Units.inches
    landing_gear.main_tire_diameter = 47.86721702883936 * Units.inches
    landing_gear.nose_tire_diameter = 46.123805705654284 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 3196.1259079903143 * Units['feet**2']
    ...
    wing.origin                  = [28.594303999999994,0,-1.53924]# meters
    wing.vertical                = False
    wing.symmetric               = True
    wing.high_lift               = True
    ...
    wing.areas.reference         = 639.2251815980629 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.twists.tip              = 0.0 * Units.degrees
    wing.origin                  = [50.635746666666655,0,5.233415999999999]
    wing.vertical                = True
    ...
    wing.areas.reference         = 799.0314769975786 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    wing.chords.tip              = wing.chords.root * wing.taper
    wing.chords.mean_aerodynamic = wing.chords.root - (2*(wing.chords.root-wing.chords.tip)*(.5*wing.chords.root+wing.chords.tip)/(3*(wing.chords.root+wing.chords.tip)))
    wing.origin                  = [53.61431999999999,0,4.61772]
    wing.vertical                = False
    wing.symmetric               = True
    ...
    fuselage.lengths.total           = 59.57146666666666 * Units.meter 
    ...
    thrust.total_design             = 129451.42506895497 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 324923.07692307694* Units.lbs
