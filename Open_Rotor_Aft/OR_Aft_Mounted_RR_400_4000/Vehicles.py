...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted400_4000'
    ...
    vehicle.mass_properties.operating_empty = 293333.3333333333 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 381333.3333333333 * Units.lbs 
