...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted200_2000'

    vehicle.mass_properties.max_takeoff = 251428.5714285714 * Units.lbs 
    vehicle.mass_properties.takeoff  = 251428.5714285714 * Units.lbs 
    vehicle.mass_properties.operating_empty = 138285.71428571426 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 182285.71428571426 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 201142.85714285713 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 2153.344208809135  * Units['feet**2']
    ...
    landing_gear.nose_tire_diameter = 39.656849776287544 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 2153.344208809135 * Units['feet**2']
    ...
    wing.areas.reference         = 430.668841761827 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 538.3360522022838 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 80136.59647125783 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 201142.85714285713* Units.lbs
