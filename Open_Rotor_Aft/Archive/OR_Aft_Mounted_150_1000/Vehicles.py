...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted150_1000'

    vehicle.mass_properties.max_takeoff = 176000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 176000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 101199.99999999999 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 134200.0 * Units.lbs 
