...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted100_1000'

    vehicle.mass_properties.max_takeoff = 117333.33333333333 * Units.lbs 
    vehicle.mass_properties.takeoff  = 117333.33333333333 * Units.lbs 
    vehicle.mass_properties.operating_empty = 67466.66666666666 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 89466.66666666666 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 93866.66666666667 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 1088.2110469909314  * Units['feet**2']
    vehicle.passengers             = 100
    vehicle.systems.control        = "fully powered" 
    vehicle.systems.accessories    = "short range" 
    vehicle.cruise_altitude    = 32214.814814814814 
    ...
    landing_gear.main_tire_diameter = 40.271039625054115 * Units.inches
    landing_gear.nose_tire_diameter = 31.19287092734588 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 1088.2110469909314 * Units['feet**2']
    ...
    wing.areas.reference         = 217.6422093981863 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 272.05276174773286 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 37397.07835325366 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 93866.66666666667* Units.lbs
