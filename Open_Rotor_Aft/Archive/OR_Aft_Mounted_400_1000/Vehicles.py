...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted400_1000'

    vehicle.mass_properties.max_takeoff = 469333.3333333333 * Units.lbs 
    vehicle.mass_properties.takeoff  = 469333.3333333333 * Units.lbs 
    vehicle.mass_properties.operating_empty = 269866.6666666666 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 357866.6666666666 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 375466.6666666667 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3574.813811780636  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 50.09764258401172 * Units.inches
    landing_gear.nose_tire_diameter = 48.27299509524663 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 3574.813811780636 * Units['feet**2']
    ...
    wing.areas.reference         = 714.9627623561273 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 893.703452945159 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 149588.31341301464 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 375466.6666666667* Units.lbs
