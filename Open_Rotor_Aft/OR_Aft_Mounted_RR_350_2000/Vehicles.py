...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted350_2000'

    vehicle.mass_properties.max_takeoff = 439999.99999999994 * Units.lbs 
    vehicle.mass_properties.takeoff  = 439999.99999999994 * Units.lbs 
    vehicle.mass_properties.operating_empty = 241999.99999999994 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 318999.99999999994 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 352000.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3402.0618556701033  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 49.08945856699553 * Units.inches
    ...
    wing.tag = 'main_wing'
    wing.areas.reference         = 3402.0618556701033 * Units['feet**2']
    ...
    wing.areas.reference         = 680.4123711340208 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 850.5154639175258 * Units['feet**2']
    wing.aspect_ratio            = 6  
