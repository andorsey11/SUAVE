...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted300_5000'

    vehicle.mass_properties.max_takeoff = 479999.99999999994 * Units.lbs 
    vehicle.mass_properties.takeoff  = 479999.99999999994 * Units.lbs 
    vehicle.mass_properties.operating_empty = 227999.99999999997 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 294000.0 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 384000.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3636.363636363636  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 50.4535394724688 * Units.inches
    landing_gear.nose_tire_diameter = 48.61592957009925 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 3636.363636363636 * Units['feet**2']
    ...
    wing.areas.reference         = 727.2727272727273 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 909.090909090909 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 152988.04780876494 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 384000.0* Units.lbs
