...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted400_2000'

    vehicle.mass_properties.max_takeoff = 502857.1428571428 * Units.lbs 
    vehicle.mass_properties.takeoff  = 502857.1428571428 * Units.lbs 
    vehicle.mass_properties.operating_empty = 276571.4285714285 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 364571.4285714285 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 402285.71428571426 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3766.0485021398  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 51.198319400143156 * Units.inches
    landing_gear.nose_tire_diameter = 49.33358325480848 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 3766.0485021398 * Units['feet**2']
    ...
    wing.areas.reference         = 753.20970042796 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 941.51212553495 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 160273.19294251566 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 402285.71428571426* Units.lbs
