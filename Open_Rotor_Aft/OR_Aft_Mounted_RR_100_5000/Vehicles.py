...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted100_5000'

    vehicle.mass_properties.max_takeoff = 160000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 160000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 76000.0 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 98000.0 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 128000.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 1445.7831325301204  * Units['feet**2']
    vehicle.passengers             = 100
    vehicle.systems.control        = "fully powered" 
    vehicle.systems.accessories    = "long range" 
    vehicle.cruise_altitude    = 34111.11111111111 
    ...
    landing_gear.main_tire_diameter = 44.40408160758088 * Units.inches
    landing_gear.nose_tire_diameter = 34.39421477887268 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 1445.7831325301204 * Units['feet**2']
    ...
    wing.areas.reference         = 289.1566265060241 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 361.4457831325301 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 50996.01593625498 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 128000.0* Units.lbs
