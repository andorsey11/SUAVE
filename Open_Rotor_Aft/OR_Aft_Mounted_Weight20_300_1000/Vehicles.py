...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted300_1000'

    vehicle.mass_properties.max_takeoff = 352000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 352000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 202399.99999999997 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 268400.0 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 281600.0 * Units.lbs 
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 281600.0* Units.lbs
