...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted300_6000'

    vehicle.mass_properties.max_takeoff = 528000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 528000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 237599.99999999997 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 303600.0 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 422400.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3905.3254437869828  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 51.991259036722134 * Units.inches
    landing_gear.nose_tire_diameter = 50.09764258401172 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 3905.3254437869828 * Units['feet**2']
    ...
    wing.areas.reference         = 781.0650887573966 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 976.3313609467457 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 168286.85258964144 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 422400.0* Units.lbs
