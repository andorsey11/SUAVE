...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted250_2000'

    vehicle.mass_properties.max_takeoff = 314285.71428571426 * Units.lbs 
    vehicle.mass_properties.takeoff  = 314285.71428571426 * Units.lbs 
    vehicle.mass_properties.operating_empty = 172857.1428571428 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 227857.1428571428 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 251428.57142857142 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 2598.4251968503936  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 44.15276551141493 * Units.inches
    landing_gear.nose_tire_diameter = 42.54464128526325 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 2598.4251968503936 * Units['feet**2']
    ...
    wing.areas.reference         = 519.6850393700787 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 649.6062992125984 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 100170.74558907229 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 251428.57142857142* Units.lbs
