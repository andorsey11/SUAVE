...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted200_3000'

    vehicle.mass_properties.max_takeoff = 270769.23076923075 * Units.lbs 
    vehicle.mass_properties.takeoff  = 270769.23076923075 * Units.lbs 
    vehicle.mass_properties.operating_empty = 142153.84615384613 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 186153.84615384613 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 216615.38461538462 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 2293.6576889661164  * Units['feet**2']
    ...
    landing_gear.nose_tire_diameter = 40.5934896544506 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 2293.6576889661164 * Units['feet**2']
    ...
    wing.areas.reference         = 458.7315377932233 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 573.4144222415291 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 86300.95004596998 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 216615.38461538462* Units.lbs
