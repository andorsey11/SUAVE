...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted350_5000'

    vehicle.mass_properties.max_takeoff = 560000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 560000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 266000.0 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 343000.0 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 448000.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 4077.669902912621  * Units['feet**2']
    ...
    landing_gear.main_tire_diameter = 52.96389031346328 * Units.inches
    landing_gear.nose_tire_diameter = 51.034848856200526 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 4077.669902912621 * Units['feet**2']
    ...
    wing.areas.reference         = 815.5339805825242 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 1019.4174757281553 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 178486.05577689243 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 448000.0* Units.lbs
