...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted350_3000'

    vehicle.mass_properties.max_takeoff = 473846.1538461538 * Units.lbs 
    vehicle.mass_properties.takeoff  = 473846.1538461538 * Units.lbs 
    vehicle.mass_properties.operating_empty = 248769.23076923072 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 325769.23076923075 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 379076.92307692306 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 3600.9353078721742  * Units['feet**2']
    vehicle.passengers             = 350
    ...
    landing_gear.main_strut_length  = 131.72360678254043 * Units.inches
    landing_gear.nose_strut_length  = 131.72360678254043 * Units.inches
    landing_gear.main_tire_diameter = 50.248883603292136 * Units.inches
    landing_gear.nose_tire_diameter = 48.418727640838576 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 3600.9353078721742 * Units['feet**2']
    ...
    wing.origin                  = [30.89723733333333,0,-1.53924]# meters
    wing.vertical                = False
    wing.symmetric               = True
    wing.high_lift               = True
    ...
    wing.areas.reference         = 720.1870615744349 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.twists.tip              = 0.0 * Units.degrees
    wing.origin                  = [54.713857777777775,0,5.233415999999999]
    wing.vertical                = True
    ...
    wing.areas.reference         = 900.2338269680436 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    wing.chords.tip              = wing.chords.root * wing.taper
    wing.chords.mean_aerodynamic = wing.chords.root - (2*(wing.chords.root-wing.chords.tip)*(.5*wing.chords.root+wing.chords.tip)/(3*(wing.chords.root+wing.chords.tip)))
    wing.origin                  = [57.932320000000004,0,4.61772]
    wing.vertical                = False
    wing.symmetric               = True
    ...
    fuselage.lengths.nose            = 12.31392 * Units.meter 
    fuselage.lengths.tail            = 18.47088 * Units.meter 
    fuselage.lengths.cabin           = 33.58444444444444 * Units.meter 
    fuselage.lengths.total           = 64.36924444444445 * Units.meter 
    fuselage.lengths.fore_space      = 9.851136 * Units.meter 
    fuselage.lengths.aft_space       = 14.776704000000002 * Units.meter 
    fuselage.width                   = 6.15696 * Units.meter
    fuselage.heights.maximum         = 6.15696 * Units.meter
    fuselage.effective_diameter      = 6.15696 * Units.meter 
    ...
    fuselage.heights.at_quarter_length = 6.15696 * Units.meter
    fuselage.heights.at_three_quarters_length = 6.15696 * Units.meter
    fuselage.heights.at_wing_root_quarter_chord = 6.15696* Units.meter
    ...
    thrust.total_design             = 151026.66258044745 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 379076.92307692306* Units.lbs
