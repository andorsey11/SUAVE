...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted100_6000'

    vehicle.mass_properties.max_takeoff = 176000.0 * Units.lbs 
    vehicle.mass_properties.takeoff  = 176000.0 * Units.lbs 
    vehicle.mass_properties.operating_empty = 79199.99999999999 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 101199.99999999999 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 140800.0 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 1575.1789976133653  * Units['feet**2']
    vehicle.passengers             = 100
    vehicle.systems.control        = "fully powered" 
    vehicle.systems.accessories    = "long range" 
    vehicle.cruise_altitude    = 34822.22222222222 
    ...
    landing_gear.nose_tire_diameter = 35.44247933108439 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 1575.1789976133653 * Units['feet**2']
    ...
    wing.areas.reference         = 315.0357995226731 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 393.7947494033413 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 56095.61752988048 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 140800.0* Units.lbs
