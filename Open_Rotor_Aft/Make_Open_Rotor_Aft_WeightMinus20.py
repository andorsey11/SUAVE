...
def main():
    ...
    tech_string = "OR_Aft_Mounted_WeightMinus20"
    ...
    for payload in payload_array:
        for design_range in range_array:
            ...
            while(converged == False and counter < maxIter):
        # create the new directory for this payload range
                ...
                thrust_guess = mtow_guess * .2  / 1.255
                wing_sweep_guess = 25
                wing_tc_guess = .095
                wing_ar_guess = 11
                fan_pressure_guess = 1.7
        ...
        #copy the seed files to the new folder
            ...
            #Optimization variables
                ...
                else: # Restrict the econ mission so it doesnt fly backwards in cruise
            ...
            #os.system("cd " + cwd +  "/" + folder_string)
               # import pdb; pdb.set_trace()
                try:
                	...
                	raise e
            #t = Timer(60*30, p.kill()) # Don't go longer than 30 minutes
                config_path = cwd + "/" + folder_string + "/config_overview.txt"
                f_read_config = open(config_path,"r")
