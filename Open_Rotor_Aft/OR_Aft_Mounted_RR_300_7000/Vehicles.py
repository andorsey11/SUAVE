...
def base_setup():
    ...
    vehicle.tag = 'OR_Aft_Mounted300_7000'

    vehicle.mass_properties.max_takeoff = 586666.6666666666 * Units.lbs 
    vehicle.mass_properties.takeoff  = 586666.6666666666 * Units.lbs 
    vehicle.mass_properties.operating_empty = 249333.33333333328 * Units.lbs 
    vehicle.mass_properties.max_zero_fuel  = 315333.33333333326 * Units.lbs 
    vehicle.mass_properties.cargo = 0.  * Units.kilogram
    vehicle.mass_properties.econ_takeoff = 469333.3333333333 * Units.lbs 
    vehicle.envelope.ultimate_load = 2.5
    vehicle.envelope.limit_load    = 1.5
    vehicle.reference_area         = 4217.252396166134  * Units['feet**2']
    ...
    landing_gear.nose_tire_diameter = 51.78820989761436 * Units.inches
    vehicle.landing_gear = landing_gear


    wing = SUAVE.Components.Wings.Main_Wing()
    wing.tag = 'main_wing'
    wing.areas.reference         = 4217.252396166134 * Units['feet**2']
    ...
    wing.areas.reference         = 843.4504792332268 * Units['feet**2']
    wing.aspect_ratio            = 1
    ...
    wing.areas.reference         = 1054.3130990415334 * Units['feet**2']
    wing.aspect_ratio            = 6  
    ...
    thrust.total_design             = 186985.39176626827 * Units.lbf
...
def configs_setup(vehicle):
    ...
    config.tag = 'econ'
    config.mass_properties.takeoff = 469333.3333333333* Units.lbs
