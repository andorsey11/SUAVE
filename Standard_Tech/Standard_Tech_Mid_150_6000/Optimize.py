...
def setup():
    ...
    problem.inputs = np.array([
        ...
        [ 'thrust'                       , 42071.71314741036  , (  12621.513944223107 , 84143.42629482072 ) ,  42071.71314741036 , Units.lbf],
      ...
      #  [ 'fan_pressure_ratio'              ,   1.65     , ( 1.05    ,         1.7)     ,       1.65      , Units.less],
        [ 'cruise_mach'                  , 0.8225, (.50   ,    .88)     , 0.8225   , Units.less],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 70.15418279999999 , 70.15418279999999 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 2795.3658536585367 , 2795.3658536585367 , Units.m],
