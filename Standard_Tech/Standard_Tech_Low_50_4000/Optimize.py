...
def setup():
    ...
    problem.inputs = np.array([
        ...
        [ 'cruise_altitude'              , 9225.383920505872 , ( 9225.383920505872 ,  43000/3.28   ) ,  9225.383920505872  , Units.m],
      ...
      #  [ 'fan_pressure_ratio'              ,   1.65     , ( 1.05    ,         1.7)     ,       1.65      , Units.less],
        [ 'cruise_mach'                  , 0.795, (.50   ,    .88)     , 0.795   , Units.less],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 67.21158599999998 , 67.21158599999998 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 2131.1991869918697 , 2131.1991869918697 , Units.m],
