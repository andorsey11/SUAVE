...
def setup():
    ...
    problem.inputs = np.array([
      ...
      #  [ 'fan_pressure_ratio'              ,   1.65     , ( 1.05    ,         1.7)     ,       1.65      , Units.less],
        [ 'cruise_mach'                  , 0.80875, (.50   ,    .88)     , 0.80875   , Units.less],
    ...
    problem.constraints = np.array([
        ...
        [ 'approach_speed', '<', 69.78378599999999 , 69.78378599999999 , Units['m/sec']],
        [ 'max_throttle', '<', .95, .95, Units.less],
        [ 'takeoff_field_length', '<', 2746.3414634146343 , 2746.3414634146343 , Units.m],
