...
def main():
    ...
    tech_string = "Standard_Tech_Low"
    payload_array = [100] #[50, 100]#, 150, 200, 250, 300, 350, 400]
    range_array   = [7000,8000] #[1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000]
...
def header_vehicle_write(vehicle_file,payload,design_range):
             ...
             vehicle_file.write("    vehicle.tag = 'StandardTechLow_" + str(payload) + "_" + str(design_range)+"'\n\n")    
             return vehicle_file
