...
def main():
    ...
    tech_string = "Standard_Tech_Mid"

    skip_payload = []
    skip_range   = [1000, 2000, 3000, 4000, 5000,6000, 7000] # Use this to skip to the one that failed


    payload_array = [250]#, 300, 350, 400]
    range_array   = [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000]
    ...
    for payload in payload_array:
        ...
        #copy the seed files to the new folder
            ...
            procedure_data[86] = '    mission.design_range = ' + str(design_range) + ' *Units.nautical_miles\n'
            ...
            min_cruise_altitude = min(cruise_alt_guess, 10000)
            ...
            optimize_data[73] = "        [ 'thrust'                       , " + str(thrust_guess)  + "  , (  " + str(thrust_guess * .3)  + " , " + str(thrust_guess * 2)  + " ) ,  " + str(thrust_guess) + " , Units.lbf],\n"
            ...
            optimize_data[76] = "        [ 'wing_sweep'                   , " +  str(wing_sweep_guess) + "        , (0     ,        45)     ,   "  + str(wing_sweep_guess) + "         , Units.deg],\n"
           ...
           # optimize_data[79] = "        [ 'fan_pressure_ratio'           , " +  str(fan_pressure_guess * .98) + ", ( 1.05 ,        " +  str(fan_pressure_guess) + ")     ,   " +   str(fan_pressure_guess)  +  "  , Units.less],\n"
            ...
            #Requirements
            optimize_data[101] = "        [ 'approach_speed', '<', " + str(approach_req * .51444) + " , " + str(approach_req * .51444) + " , Units['m/sec']],\n"
            optimize_data[103] = "        [ 'takeoff_field_length', '<', " + str(takeoff_req / 3.28) + " , " + str(takeoff_req / 3.28) + " , Units.m],\n"
...
def header_vehicle_write(vehicle_file,payload,design_range):
             ...
             vehicle_file.write("    vehicle.tag = 'StandardTechMid_" + str(payload) + "_" + str(design_range)+"'\n\n")    
             return vehicle_file
...
def top_level_write(vehicle_file,payload,design_range):
            ...
            mach_req = .74 + .11 * (design_range / 8000)
...
def engine_write(vehicle_file,payload,design_range):
  # ------------------------------------------------------------------
    ...
    #Component 9 : fan   
            ...
            vehicle_file.write("    fan.spinner_ratio         = 1.25 \n")
