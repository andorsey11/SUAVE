...
# ----------------------------------------------------------------------
## @ingroup Analyses-Aerodynamics
class Fidelity_Zero_BWB(Markup):
    ...
    def __defaults__(self):
        ...
        compute.drag.parasite.pylons               = Common.Drag.parasite_drag_pylon_BWB
        ...
        compute.drag.compressibility.wings.wing    = Common.Drag.compressibility_drag_wing_BWB
    ...
    def initialize(self):
        ...
        self.geometry
        """                  
        super(Fidelity_Zero_BWB, self).initialize()
